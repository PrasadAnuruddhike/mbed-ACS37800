...
const int ACS37800_DEFAULT_I2C_ADDRESS = 0x6B << 1;      // 0x60
...
class ACS37800
{
    public:
        ...
        ACS37800ERR writeRegister(uint32_t value, uint8_t address);
    ...
    private:
        ...
        int _ACS37800Address = ACS37800_DEFAULT_I2C_ADDRESS;
